...
<execution_context>
@C:/DEVIL'S ADVOCATE/.codex/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@C:/DEVIL'S ADVOCATE/.codex/get-shit-done/workflows/check-todos.md`.
