...
<execution_context>
@C:/DEVIL'S ADVOCATE/.codex/get-shit-done/workflows/add-todo.md
</execution_context>
...
<process>
**Follow the add-todo workflow** from `@C:/DEVIL'S ADVOCATE/.codex/get-shit-done/workflows/add-todo.md`.
