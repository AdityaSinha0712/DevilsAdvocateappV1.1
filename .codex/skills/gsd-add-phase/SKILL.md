...
<execution_context>
@C:/DEVIL'S ADVOCATE/.codex/get-shit-done/workflows/add-phase.md
</execution_context>
...
<process>
**Follow the add-phase workflow** from `@C:/DEVIL'S ADVOCATE/.codex/get-shit-done/workflows/add-phase.md`.
