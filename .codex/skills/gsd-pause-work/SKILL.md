...
<execution_context>
@C:/DEVIL'S ADVOCATE/.codex/get-shit-done/workflows/pause-work.md
</execution_context>
...
<process>
**Follow the pause-work workflow** from `@C:/DEVIL'S ADVOCATE/.codex/get-shit-done/workflows/pause-work.md`.
