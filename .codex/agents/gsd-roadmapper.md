...
Reference full template: `C:/DEVIL'S ADVOCATE/.codex/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/DEVIL'S ADVOCATE/.codex/get-shit-done/templates/state.md`.
