...
```bash
PHASE_INFO=$(node "C:/DEVIL'S ADVOCATE/.codex/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "C:/DEVIL'S ADVOCATE/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node "C:/DEVIL'S ADVOCATE/.codex/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
